        ...
        function recursiveRenderDept(deptList) {
            if(deptList && deptList.length > 0) {
                $(deptList).each(function (i, dept) {
                    ...
                    if (dept.deptLevelDtos.length > 0) {
                        var rendered = Mustache.render(deptListTemplate, {deptList: dept.deptLevelDtos});
                        $("#dept_" + dept.id).append(rendered);
                        recursiveRenderDept(dept.deptLevelDtos);
                    }
                })
            }
        }
        ...
        function recursiveRenderDeptSelect(deptList, level) {
            ...
            if (deptList && deptList.length > 0) {
                $(deptList).each(function (i, dept) {
                    ...
                    if (dept.deptLevelDtos && dept.deptLevelDtos.length > 0) {
                        recursiveRenderDeptSelect(dept.deptLevelDtos, level + 1);
                    }
                });
            }
        }
